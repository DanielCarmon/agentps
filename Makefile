# agentps — Makefile.  Vibecoded by Daniel Carmon and Claude Opus 4.8.  GNU GPL v3.0-or-later.
PREFIX ?= $(HOME)/.local

.PHONY: install uninstall help

help:
	@echo "make install    - install the agentps CLI + capture hooks for your agents"
